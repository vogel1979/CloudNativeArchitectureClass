= Lab 1 - Getting Started with Spring Cloud Stream (http://docs.spring.io/spring-cloud-stream/docs/1.0.2.RELEASE/reference/htmlsingle/index.html#consumer-groups)
...
Unpack that zip file at `$COURSE_HOME/day_05/session_01/lab_01/initial`.
