...
In this Lab, we'll run our `Hello World`-Application with the built-in Tomcat and discover how to change this to Jetty.

NOTE: The completed code for this lab can be found at `$COURSE_HOME/day_01/session_01/lab_02/complete/hello-spring-boot`.
