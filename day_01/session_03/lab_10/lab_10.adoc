...
In this lab we'll bind our RESTful web service from link:../lab_09/lab_09.html[Lab 9] to a MySQL database and leverage link:http://cloud.spring.io/spring-cloud-connectors/spring-cloud-spring-service-connector.html[Spring Cloud Connectors] to easily connect to it.
