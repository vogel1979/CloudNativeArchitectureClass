...
. Prebuilt the Application if your PCF instance does not have internet access (Install spring boot cli: http://docs.spring.io/autorepo/docs/spring-boot/1.1.4.RELEASE/reference/html/getting-started-installing-spring-boot.html#getting-started-installing-the-cli):
+
----
